...
import smart.plantpot.cot.entities.ConnectedObject;
import org.eclipse.microprofile.config.Config;
import org.eclipse.microprofile.config.ConfigProvider;
import smart.plantpot.cot.boundaries.PublishWebsocketEndpoint;
...
public class MqttMessageEventManager {
    ...
    public void start() {
        ...
        try {
            ...
            MqttListener.listen("camera");
            MqttListener.listen("sensor");
                ...
                public void messageArrived(String topic, MqttMessage mqttMessage) {
                    ...
                    switch (topic){
                        case "sensor":
                            ...
                            System.out.println("Message on " + topic + ": '" + "received" + "'");
                            ...
                            PublishWebsocketEndpoint.broadcastSensorMessage(sensor);
                        ...
                        case "camera":
                            ...
                            PublishWebsocketEndpoint.broadcastCameraMessage(camera);
